...
const item = (turnId: string, id: string, text: string) => ({
  type: "message",
  id,
  role: "user",
...
save({ status: "passed", runtimeVersion: VERSION, at: new Date(now).toISOString(), capabilities: capture, retainedReuse: true });
