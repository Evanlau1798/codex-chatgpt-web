...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  setApiAccessEnabled: (enabled) => ipcRenderer.invoke("launcher:api-access-enabled", enabled),
  generateApiAccessKey: () => ipcRenderer.invoke("launcher:api-access-generate"),
  resetApiAccessKey: () => ipcRenderer.invoke("launcher:api-access-reset"),
  copyApiAccessEndpoint: () => ipcRenderer.invoke("launcher:api-access-copy-endpoint"),
  copyApiAccessKey: () => ipcRenderer.invoke("launcher:api-access-copy-key"),
  ...
  setExperimentalNoAutoCompact: (enabled) => ipcRenderer.invoke("launcher:no-auto-compact", enabled),
