export const ko = {
  ...
  accountSafetyBody: "Automatic ChatGPT Web을 위한 로컬 보호 기능입니다. 이 제한은 런처의 안전 제어이며 ChatGPT의 실제 할당량 표시가 아닙니다.",
  maximumConcurrentWebTurns: "최대 동시 Web 턴",
  maximumConcurrentWebTurnsBody: "Automatic Web 브라우저 턴 동시 실행 수를 1–6으로 제한합니다. Standard Web 세션 모드의 실제 상한은 5입니다.",
  automaticWebSessionLimit: "최대 연속 Automatic Web 세션",
  automaticWebSessionLimitBody: "지정한 분 수에 도달하면 새 Automatic Web 작업을 일시 중지합니다. 진행 중인 턴에는 먼저 안전한 마무리를 요청합니다.",
  ...
  accountSafetyReasonDuration: "로컬 시간 제한 도달",
