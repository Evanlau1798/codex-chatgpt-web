...
const en = {
  ...
  accountSafetyBody: "Local protection for Automatic ChatGPT Web. These limits are launcher safety controls, not ChatGPT quota measurements.",
  maximumConcurrentWebTurns: "Maximum concurrent Web turns",
  maximumConcurrentWebTurnsBody: "Limit simultaneous Automatic Web browser turns from 1 to 6. Standard Web session mode still caps effective concurrency at 5.",
  automaticWebSessionLimit: "Maximum continuous Automatic Web session",
  automaticWebSessionLimitBody: "Optionally pause new Automatic Web work after this many minutes. Existing active turns are asked to finish cleanly first.",
  ...
  accountSafetyReasonDuration: "Local duration limit reached",
...
const zh: Record<keyof typeof en, string> = {
  ...
  accountSafetyBody: "针对 Automatic ChatGPT Web 的本机保护。这些限制是启动器的安全控制，不代表 ChatGPT 实际配额。",
  maximumConcurrentWebTurns: "最大并发 Web 任务",
  maximumConcurrentWebTurnsBody: "将 Automatic Web 同时运行的浏览器任务限制在 1–6。Standard Web 会话模式的实际并发上限仍为 5。",
  automaticWebSessionLimit: "最长连续 Automatic Web 会话",
  automaticWebSessionLimitBody: "可选地在达到指定分钟数后暂停新的 Automatic Web 工作；现有活动任务会先收到收尾指令。",
  ...
  accountSafetyReasonDuration: "已达到本机时长上限",
