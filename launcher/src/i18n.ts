...
const en = {
  ...
  accountSafetyBody: "This is a local launcher guard, not ChatGPT quota telemetry. It counts unique Automatic Web sessions in the configured window, stops admitting new sessions at the limit, and asks already-active work to finish cleanly. ChatGPT rate-limit and account-security warnings still trigger separate protection states.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  accountSafetyBody: "这是启动器的本地保护，不是 ChatGPT 配额遥测。它会统计时间窗口内的唯一 Automatic Web 会话；达到上限后停止接收新会话，并要求已在运行的工作安全收尾。ChatGPT 的速率限制与账户安全警告仍会触发独立保护状态。",
