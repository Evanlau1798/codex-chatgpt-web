...
const en = {
  ...
  noAutoCompact: "Disable Codex auto compact (experimental)",
  noAutoCompactBody: "Removes routed context limits from Codex and rejects compact handoffs. Token usage remains accurate, oversized browser prompts still fail closed, and Claude Code is unchanged. Restart Codex after changing it. Disabled by default.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  noAutoCompact: "停用 Codex 自动压缩（实验性）",
  noAutoCompactBody: "从 Codex 隐藏路由模型的上下文限制，并拒绝压缩交接。Token 用量仍会如实计算，过大的浏览器提示仍会安全失败，Claude Code 不受影响。更改后请重启 Codex。默认关闭。",
