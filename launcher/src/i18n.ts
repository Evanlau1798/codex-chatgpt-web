...
const en = {
  ...
  accountSafetySessionsUsed: "{used} / {limit} sessions used",
  accountSafetyUsageMeter: "Automatic Web session usage",
  accountSafetyDisabled: "Session limit disabled",
  applyAccountSafety: "Apply safety settings",
...
const zh: Record<keyof typeof en, string> = {
  ...
  accountSafetySessionsUsed: "已使用 {used} / {limit} 个会话",
  accountSafetyUsageMeter: "Automatic Web 会话使用量",
  accountSafetyDisabled: "会话限制已关闭",
  applyAccountSafety: "应用安全设置",
