...
const zh: Record<keyof typeof en, string> = {
  ...
  apiAccessWarningBody: "此端点供 Pi 等 Agentic 界面及外部 harness 接入。建议搭配账户安全保护，但本地限制不能保证避免 ChatGPT 限流。API 密钥只应交给可信任的本地工具，切勿公开。每段对话可能耗费较长时间，频繁请求容易触发 429 Too many requests。若出现 429 或账户安全警告，请停止发送请求并检查账户状态。用户须自行承担不当使用造成的账户风险；本项目及开发者不对因此产生的账户限制、暂停使用或封禁负责。",
