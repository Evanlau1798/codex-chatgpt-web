...
const en = {
  ...
  newCompactMode: "Use new compact mode (Beta)",
  newCompactModeBody: "Wait for Codex to request compaction, then ask the active ChatGPT Web agent for a handoff. Changing this restarts the local runtime.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  newCompactMode: "使用新版 compact 壓縮方式（Beta）",
  newCompactModeBody: "等待 Codex 请求压缩后，再由当前 ChatGPT Web Agent 输出 handoff。更改此设置会重启本地运行时。",
