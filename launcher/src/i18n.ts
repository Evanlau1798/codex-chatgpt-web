...
const en = {
  ...
  enhancedWebSessionModeBody: "Enable retained conversations, steering, handoff compaction, and large-context archive transport for ChatGPT Web models. Changing this restarts the local runtime.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  enhancedWebSessionModeBody: "為 ChatGPT Web 模型啟用對話保留、steering、handoff 壓縮與大型上下文封存傳輸。變更此設定會重新啟動本機執行階段。",
