...
export const ja: Record<keyof Copy, string> = {
  ...
  accountSafetyBody: "Automatic ChatGPT Web 向けのローカル保護です。これらはランチャー側の安全制限であり、ChatGPT の実際のクォータ表示ではありません。",
  maximumConcurrentWebTurns: "Web ターンの最大同時実行数",
  maximumConcurrentWebTurnsBody: "Automatic Web の同時ブラウザーターンを 1～6 に制限します。Standard Web セッションモードの実効上限は 5 のままです。",
  automaticWebSessionLimit: "Automatic Web の最大連続セッション",
  automaticWebSessionLimitBody: "指定した分数に達したら新しい Automatic Web 作業を一時停止します。進行中のターンには先に安全な終了を依頼します。",
  ...
  accountSafetyReasonDuration: "ローカル時間上限に到達",
