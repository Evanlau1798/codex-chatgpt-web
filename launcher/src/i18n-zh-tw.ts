export const zhTW = {
  ...
  accountSafetyBody: "針對 Automatic ChatGPT Web 的本機保護。這些限制是啟動器安全控制，不代表 ChatGPT 的實際配額。",
  maximumConcurrentWebTurns: "最大並行 Web 任務",
  maximumConcurrentWebTurnsBody: "將 Automatic Web 同時執行的瀏覽器任務限制在 1–6。Standard Web 工作階段模式的實際並行上限仍為 5。",
  automaticWebSessionLimit: "最長連續 Automatic Web 工作階段",
  automaticWebSessionLimitBody: "可選擇在達到指定分鐘數後暫停新的 Automatic Web 工作；既有活動任務會先收到收尾指令。",
  ...
  accountSafetyReasonDuration: "已達到本機時間上限",
