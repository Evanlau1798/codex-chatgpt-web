...
test("CI packages and smoke-launches on macOS, Windows, and Linux", () => {
  ...
  assert.match(ci, /prepare-windows-baseline-bun\.ps1 -Version 1\.4\.0 -ReleaseTag canary -Revision 1\.4\.0-canary\.1\+52bf09cb1/);
  ...
  assert.match(release, /prepare-windows-baseline-bun\.ps1 -Version 1\.4\.0 -ReleaseTag canary -Revision 1\.4\.0-canary\.1\+52bf09cb1/);
