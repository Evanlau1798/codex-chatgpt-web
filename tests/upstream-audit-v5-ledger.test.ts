...
describe("upstream v5.0.0 audit ledger", () => {
  ...
  test("reopened manual obligations have specific source and assertion links, not just path coverage", () => {
    ...
    expect(review.obligations.map(item => item.id).sort()).toEqual([
      ...
      "manual-body-limit", "manual-client-polling", "manual-clipboard-transaction", "manual-compaction-canonical", "manual-compaction-reconnect", "manual-control-admission", "manual-duplicate-deadline",
      "manual-mcp-contract",
