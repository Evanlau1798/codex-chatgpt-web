...
describe("upstream v5.0.0 audit ledger", () => {
  ...
  test("reopened manual obligations have specific source and assertion links, not just path coverage", () => {
    ...
    expect(review.obligations.map(item => item.id).sort()).toEqual([
      "automatic-effort-activation", "automatic-send-stage", "automatic-submission-recovery", "automatic-surface-readiness", "automatic-tool-observation",
      ...
      "manual-body-limit", "manual-client-polling", "manual-clipboard-transaction", "manual-compaction-admission", "manual-compaction-canonical", "manual-compaction-reconnect", "manual-control-admission", "manual-duplicate-deadline",
      "manual-mcp-contract",
      "manual-mode-transaction",
      "manual-native-owner",
      "manual-native-placement",
      "manual-navigation-superseded",
      "manual-owner-death", "manual-owner-liveness", "manual-primary-surface", "manual-provider-catalog", "manual-registration-validation", "manual-resume-validation",
