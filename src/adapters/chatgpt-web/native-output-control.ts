...
export const CODEX_OUTPUT_CONTROL_PROMPT = [
  ...
  "At task startup, for work requiring tools: After required context verification and reconstruction, promptly send one brief task-facing commentary through this control before extended planning, unless the user requested silence. Then discover and invoke the first authorized, bounded read needed for the task. Preserve applicable instructions and approvals; do not expose transport details or hidden reasoning. Tasks needing no tools can proceed directly to their answer.",
