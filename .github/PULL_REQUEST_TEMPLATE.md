...
- [ ] If this changes browser UI, launcher ownership, or Web transport, I ran one low-usage Web contract smoke and did not retry a 429 or verification limit; `browserIdle` was true, but I did not treat it as proof of full daemon idle.
